...
namespace Memom.FaceDetection
{
    public class FindMatchResult
    {
        ...
        public string MatchedFaceFile { get; set; }
    ...
    public class MatchInput
    {
        public MatchInput()
        {
            this.InlierThreshold = 10;
        }
        public System.IO.FileInfo FindInFile { get; set; }
        public System.IO.FileInfo MatchFile { get; set; }
        public int InlierThreshold { get; set; }
        public string WebFolderPath { get; set; }
    ...
    public class BruteForceMatcher
    {
        ...
        public static Image<Bgr, Byte> Draw(Image<Gray, Byte> modelImage, Image<Gray, byte> observedImage, out long matchTime, out int Inliers, out int OutLiers)
        {
            ...
            Inliers = homoInliers;
            OutLiers = mask.Rows - homoInliers;
