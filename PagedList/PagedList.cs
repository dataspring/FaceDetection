...
namespace PagedList
{
	...
	public class PagedList<T> : BasePagedList<T>
	{
        ...
        /// for WCF
        /// </summary>
        public PagedList(IEnumerable<T> superset, PagedListMetaData pageMeta)
        {
            ...
            IsFirstPage = pageMeta.IsFirstPage;
            IsLastPage = pageMeta.IsLastPage;
            FirstItemOnPage = pageMeta.FirstItemOnPage;
            LastItemOnPage = pageMeta.LastItemOnPage;
