...
namespace PagedList
{
	...
	public static class PagedListExtensions
	{
        ...
        /// <summary>
        /// Creates a subset for WCF
        /// </summary>
        public static IPagedList<T> ToPagedList<T>(this IEnumerable<T> superset, PagedListMetaData pageMeta)
        {
            return new PagedList<T>(superset, pageMeta);
        }
